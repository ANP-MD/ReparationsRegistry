...
namespace AkulavLauncherInstaller
{
    ...
    {
        readonly static string location = "C:\\RepairRegistry\\";
        readonly string fileLocation = "C:\\RepairRegistry\\file.zip";
        readonly string updateFlag = "C:\\RepairRegistry\\update.txt";
        ...
        private void InstallBtn_Click(object sender, EventArgs e)
        {
            ...
            link.SetPath(@"C:\\RepairRegistry\\RepairRegistry.exe");

            // save it
            IPersistFile file = (IPersistFile)link;
            string desktopPath = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory);
            file.Save(Path.Combine(desktopPath, "RepairRegistry.lnk"), false);

            var p = new Process();
            p.StartInfo.FileName = @"C:\RepairRegistry\RepairRegistry.exe";
            p.Start();
        ...
        private void UninstallBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                File.Delete(Path.Combine(desktopPath, "RepairRegistry.lnk"));
